      ...
      body: CustomScrollView(
        slivers: [
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(child: _ProfileHero(person: person, health: health)),
          ),
          SliverPadding(
          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(child: _SectionTitle(title: 'TIMELINE', action: 'ADD NOTE', onAction: () => _showNote(context, person))),
          ),
          SliverPadding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            sliver: SliverList.builder(
              itemCount: interactions.length,
              itemBuilder: (context, index) => _TimelineItem(interaction: interactions[index]),
            ),
          ),
          SliverPadding(
            padding: const EdgeInsets.fromLTRB(20, 24, 20, 10),
            sliver: SliverToBoxAdapter(child: _SectionTitle(title: 'MEMORIES & NOTES')),
          ),
          SliverPadding(
...
class _ProfileHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(gradient: const LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [TetherColors.surfaceRaised, TetherColors.surface]), borderRadius: BorderRadius.circular(26), border: Border.all(color: TetherColors.line)),
...
class _QuickStats extends StatelessWidget {
  const _QuickStats({required this.person}); final Person person;
  @override
